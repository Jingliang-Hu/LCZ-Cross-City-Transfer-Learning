...
paraDict = {
        ...
        "trainData": "lcz42",#"lcz42", # training data could be the training data of LCZ42 data, or data of one of the cultural-10 city
...
confFlag = paraDict["confidenceModel"]
confThres = paraDict["confidenceThreshold"]
