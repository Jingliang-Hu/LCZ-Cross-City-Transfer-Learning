...
paraDict = {
        ...
        "trainData": "munich_copy", # training data could be the training data of LCZ42 data, or data of one of the cultural-10 city
        "testData": "moscow_alpha_copy",  # testing data could be all the data of the cultural-10 cities, or one of them.
        "normalization":"cms", # "ms": mean-std normalization, patch-wise
        "datFlag":2, # data selection: sentinel-1, sentinel-2, or both

        ### data augumentation, flip and gaussion noise
        "aug_flip":1,
        "aug_noise_std":0.00001,
...
aug_flip =  paraDict["aug_flip"]
aug_noise_std = paraDict["aug_noise_std"]
