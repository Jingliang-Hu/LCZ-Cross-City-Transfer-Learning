...
paraDict = {
        ...
        "trainData": "munich1_copy", # training data could be the training data of LCZ42 data, or data of one of the cultural-10 city
        "testData": "moscow1_copy",  # testing data could be all the data of the cultural-10 cities, or one of them.
