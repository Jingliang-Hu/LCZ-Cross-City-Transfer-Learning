...
model = resnetModel.LeNet_feature_fusion(inChannel_1=trainDataSet.nbChannel()[0], inChannel_2=trainDataSet.nbChannel()[1], nbClass = trainDataSet.label.shape[1]).to(cudaNow)
