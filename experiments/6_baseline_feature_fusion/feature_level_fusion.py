...
model = resnetModel.LeNet_feature_fusion(inChannel_1=trainDataSet_s1.nbChannel(), inChannel_2=trainDataSet_s2.nbChannel(), nbClass = trainDataSet_s2.label.shape[1]).to(cudaNow)
...
codes for saving and loading models:
	...
	Load:
		...
		model.eval()
'''
model_name = 'feature_level_fusion'
